...
class FLog {
  ...
  Object encode() {
    ...
    pigeonMap['logId'] = logId;
    return pigeonMap;
  }

  static FLog decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return FLog()
      ..logId = pigeonMap['logId'] as String?;
  }
}

class NativeLogApi {
  Future<void> log(FLog arg) async {
    final Object encoded = arg.encode();
    const BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.NativeLogApi.log', StandardMessageCodec());
