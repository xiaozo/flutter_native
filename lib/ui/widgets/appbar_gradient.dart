...
import 'app_navigation_toolbar.dart';
...
class _GradientAppBarState extends State<GradientAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget leadings;
    if (widget.leadings != null &&
        widget.leadings.isNotEmpty &&
        widget.leading == null) {
      if (widget.leadings.length > 1) {
        //加入item的间距
        int index = 0;
        int insertIndex = 1;
    ...
    final Widget toolbar = AppNavigationToolbar(
      leading: leading,
      middle: title,
      trailing: actions,
